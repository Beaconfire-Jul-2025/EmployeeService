...
public class EmployeeService {
    ...
    public Optional<Employee> getEmployeeByUserId(String userId) {
        return getEmployeeByUserId(userId, APPLICATION_TYPE_PROFILE);
    }

    public Optional<Employee> getEmployeeByUserId(String userId, String applicationType) {
        Query query = new Query(Criteria.where("userId").is(userId)
                .and("applicationType").is(applicationType));
    ...
    public Page<Employee> getEmployees(String firstName, String lastName, String email, int page, int size, String sortBy, String sortDir) {
        ...
        query.addCriteria(Criteria.where("applicationType").is(APPLICATION_TYPE_PROFILE));
